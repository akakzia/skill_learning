...
for i in range(nb_seeds):
    for model in models:
        ...
        with open(job_file, 'w') as fh:
            ...
            fh.writelines("srun python -u -B train.py --algo 'semantic' --n-blocks 2 --n-epochs 1000 --n-cycles 50 --n-batches 30 --architecture {} --save-dir 'test_{}/' 2>&1 ".format(model, model))
