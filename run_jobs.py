...
for i in range(nb_seeds):
    ...
    with open(job_file, 'w') as fh:
        ...
        fh.writelines("#SBATCH --output=first_stage%_%j.out\n")
        fh.writelines("#SBATCH --error=first_stage%_%j.out\n")
        ...
        fh.writelines("srun python -u -B train.py --algo 'semantic' --n-blocks 2 --n-epochs 100 --n-cycles 50 --n-batches 30 --architecture 'full_gn' --save-dir 'first_stage/' 2>&1 ")
